    ...
    public void paragraph14a_pvInverterTest() throws Exception {
        ...
        new ControllerTest(sut)
                ...
                .activate(MyConfig.create()
                        ...
                        .setPvInverterIds(new String[]{"pvInverter0"})
                        .setPvInverterMaxActivePower(new String[]{"20000"})
                        .build()
                        ...
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_HARDWARE_MAX_ACTIVE_POWER, 20000)
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 20000)
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTER_SUM_ACTIVE_POWER, 1000)
                ...
                // limit 60%
                        ...
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 16500)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 14750)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13875)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13438)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13219)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13110)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13055)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13028)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13014)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13007)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13004)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13002)
                ).next(new TestCase()
                        .output("ctrlEvcs0", ControllerParagraph14a.ChannelId.PVINVERTERS_ACTIVE_POWER_LIMIT_SUM, 13001)
                        ...
                        .output("pvInverter0", ManagedSymmetricPvInverter.ChannelId.ACTIVE_POWER_LIMIT, 14300)
                ).next(new TestCase(), RAMP_CYCLES).next(new TestCase()
    ...
    public void paragraph14a_twoPvInverterTest() throws Exception {
        ...
        new ControllerTest(sut)
                ...
                .activate(MyConfig.create()
                        ...
                        .setInputRelaisId4("io0/InputOutput3")
                        .setGridmeterId("meter0")
                        .setPvInverterIds(new String[]{"pvInverter0","pvInverter1"})
                        .setPvInverterMaxActivePower(new String[]{"7000", "13000"})
                        .build()
                ).next(new TestCase() // c 1000, p 4000, g -3000
                        .input("io0", DummyInputOutput.ChannelId.INPUT_OUTPUT2, false)
                        .input("io0", DummyInputOutput.ChannelId.INPUT_OUTPUT3, false)
    ...
    public void paragraph14a_pvInverterWithEvcsClusterTest() throws Exception {
        ...
        new ControllerTest(sut)
                ...
                .activate(MyConfig.create()
                        ...
                        .setGridmeterId("meter0")
                        .setPvInverterIds(new String[]{"pvInverter0", "pvInverter1"})
                        .setPvInverterMaxActivePower(new String[]{"10000", "5000"})
    ...
    public void paragraph14a_simpleEvcsClusterTest() throws Exception {
        ...
        new ControllerTest(sut)
                ...
                .activate(MyConfig.create()
                        ...
                        .setGridmeterId("meter0")
                        .setPvInverterIds(new String[]{"pvInverter0"})
                        .setPvInverterMaxActivePower(new String[]{"10000"})
                        .setEvcsIds(new String[]{"evcsCluster0"})
                        .build()
